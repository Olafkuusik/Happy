...
class Builder_Image_Pro {
	...
	public function enqueue() {
		wp_enqueue_script( 'builder-image-pro', $this->url . 'assets/scripts.js', array( 'jquery' ), $this->version, true );
		wp_enqueue_style( 'builder-image-pro', $this->url . 'assets/style.css', null, $this->version );
	}

	public function admin_enqueue() {
		wp_enqueue_style( 'builder-image-pro-admin', $this->url . 'assets/admin.css' );
	}
