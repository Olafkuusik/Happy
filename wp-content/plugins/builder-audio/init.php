...
class Builder_Audio {
	...
	public function enqueue() {
		wp_enqueue_style( 'builder-audio', $this->url . 'assets/style.css', null, $this->version );
		wp_register_script( 'builder-audio', $this->url . 'assets/script.js', array( 'jquery' ), $this->version, true );
		wp_enqueue_script( 'builder-audio' );
	}

	public function admin_enqueue() {
		wp_enqueue_script( 'builder-audio' );
		wp_enqueue_style( 'builder-audio-admin', $this->url . 'assets/admin.css' );
	}
