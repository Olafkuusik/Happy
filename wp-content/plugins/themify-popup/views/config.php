...
return array(
	...
	array(
		...
		'meta' => array(
			...
			array('value' => 'default', 'name' => __('Page Viewed','themify-popup')),
	...
	array(
		...
		'after' => __( ' Display popup after [n] page views.', 'themify-popup' ),
		'type' => 'textbox',
	...
	array(
		...
		'title' 	=> __('Show Only Once', 'themify-popup'),
		'label' 	=> __('Do not display the popup again, until the cookie expires.', 'themify-popup'),
		'description' => '',
		'type' 		=> 'checkbox',
	),
	array(
		...
		'title' => '',
		'before' => __('Expire cookie in ', 'themify-popup'),
		'after' => __( ' Days', 'themify-popup' ),
		'type' => 'textbox',
		'meta' => array('size' => 'small')
	),
	array(
	...
	array(
		...
		'title' 	=> __('Mobile Disable', 'themify-popup'),
		'label' => __('Disable popup on mobile', 'themify-popup'),
		'description' => '',
		'type' 		=> 'checkbox',
	),
	array(
