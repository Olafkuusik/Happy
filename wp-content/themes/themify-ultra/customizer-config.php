...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'scheme_link_color' => array(
			...
			'selector' => 'a, body #headerwrap a, body #footerwrap a, body #main-nav a, body .sidemenu a, body .post-nav .arrow, body .widget .social-links a, body .widget .social-links a:hover, body .footer-nav li a',
			'prop' => 'color',
		),
