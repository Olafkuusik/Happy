...
e[f]=a;c.removeClass("loading")}))}});c.on("mouseenter","> a",function(){a(this).closest("li").find(".mega-sub-menu .mega-link:first").trigger(b.events)}).on("dropdown_open",function(){a(this).find(".mega-sub-menu .mega-link:first").trigger(b.events)})})}})(jQuery);
