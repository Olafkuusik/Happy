...
this.filter("img"),l=d.length;d.bind("load.imgloaded",function(){0>=--l&&"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="!==this.src&&(d.unbind("load.imgloaded"),b.call(d,this))}).each(function(){if(this.complete||void 0===this.complete){var b=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=b}});return this})})(jQuery);
