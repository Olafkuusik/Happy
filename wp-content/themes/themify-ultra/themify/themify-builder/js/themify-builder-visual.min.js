...
[""]));d.$context.find("#background_"+c).trigger("change")}})};b.prototype.bindBackgroundGradient=function(a,b,c){function d(){if("undefined"===typeof d.pre){var a=window.getComputedStyle(document.documentElement,"");d.pre=(Array.prototype.slice.call(a).join("").match(/-(moz|webkit|ms)-/)||""===a.OLink&&["","o"])[1]}return d.pre}if(this.isInit){var e=this.getValue(a),f={};if(e){b=b.replace(/background-image:/ig,"").split(";");var g={moz:0,webkit:4,o:2,ms:3};a=d();b=g[a]&&b[g[a]]?b[g[a]]:b[4];if(c)return b;
f[e.prop]=b;this.setLiveStyle(f,e.selector)}}};b.prototype.bindModuleLayout=function(){var d=this,b={layout_feature:"",layout_menu:"ul.ui.nav:first"};Object.keys(b).forEach(function(c){d.$context.on("click","#"+c+" > a",function(){var e=a(this).attr("id"),f=d.$liveStyledElmt;""!==b[c]&&(f=d.$liveStyledElmt.find(b[c]));var g=d.getStylingVal(c);"layout_feature"===c&&(e="layout-"+e,g="layout-"+g);f.removeClass(g).addClass(e);"layout_feature"===c&&(e=e.substr(7));d.setStylingVal(c,e)})})};b.prototype.bindModuleRadio=
function(){var b=this,c={buttons_style:"> .module-buttons",buttons_size:"> .module-buttons",icon_style:"> .module-icon",icon_size:"> .module-icon",icon_arrangement:"> .module-icon"};Object.keys(c).forEach(function(d){b.$context.on("change","#"+d+' input[type="radio"]',function(){if(b.$liveStyledElmt){var e=a(this).val(),f=""!==c[d]?b.$liveStyledElmt.find(c[d]):b.$liveStyledElmt,g=b.getStylingVal(d);f.removeClass(g).addClass(e);b.setStylingVal(d,e)}})})};b.prototype.bindModuleColor=function(){var b=
this,c={color_menu:"ul.ui.nav:first",mod_color_pricing_table:["","> .module-pricing-table-header",".module-pricing-table-button"],icon_color_bg:"> .module-icon i"},e=Object.keys(c).reduce(function(a,b,d){0!==d&&(a+=",");return a+("#"+b+" > a")},"");b.$context.on("click",e,function(){var d=a(this),e=d.parent().attr("id"),f=a(this).attr("id"),g=d.closest(".themify_builder_row_js_wrapper"),h=c[e];Array.isArray(h)||(h=[h]);var l=a([]);h.forEach(function(a){l=""===a?l.add(b.$liveStyledElmt):l.add(b.$liveStyledElmt.find(a))});
if(0<g.length){var m=d.closest(".themify_builder_row").index();var k=e;e+="_"+m;l=a(l[m])}d=b.getStylingVal(e);!d&&0<g.length&&(g=b.getStylingVal(g.attr("id")),g[m]&&g[m][k]&&(d=g[m][k]));l.removeClass(d).addClass(f);b.setStylingVal(e,f)})};b.prototype.setApplyBorder=function(b,c,e){var d=this.getValue(b),f={};d&&("color"===e&&"rgba(0, 0, 0, 1)"===c&&(c="",""===a("#"+b.replace("color","width")).val()&&(f["border-style"]="")),f["border-"+e]="width"===e?0<c?c+"px":"":c,this.setLiveStyle(f,d.selector))};
b.prototype.bindChangesEvent=function(){var d=this;a("body").delegate(d.style_tab+" select,"+d.style_tab+' input[type="radio"],'+d.style_tab+" .themify-builder-uploader-input","change",function(){if(d.isInit){var c=a(this).is("select")||a(this).hasClass("themify-builder-uploader-input")?a(this).prop("id"):a(this).parent(".tfb_lb_option").prop("id"),c=d.getValue(c),e={};if(c){var g=a(this).val(),p=c.selector;if(!_.isNull(g)){if(a(this).hasClass("font-family-select"))"default"===g||d.isWebSafeFont(g)?
"default"===g&&(g=""):ThemifyBuilderCommon.loadGoogleFonts([g.split(" ").join("+")+":400,700:latin,latin-ext"],d.iframe);else if(a(this).hasClass("themify-builder-uploader-input"))if(0<a(this).closest(".themify_builder_input").find(".thumb_preview").length)g=g?"url("+g+")":"none";else return d.$liveStyledElmt.data("fullwidthvideo",g),0<g.length?ThemifyBuilderModuleJs.fullwidthVideo(d.$liveStyledElmt):b.removeBgVideo(d.$liveStyledElmt),!1;else if(!a(this).hasClass("style_field_select")&&a(this).is("select")&&
0<a(this).find('[value="dashed"]').length&&("none"!==g&&!parseInt(a(this).closest(".themify_builder_input").find(".style_border").val())||a(this).closest(".themify_builder_field").nextAll(".themify_builder_field").last().find(".style_apply_all_border").is(":checked")))return!1;e[c.prop]=g;d.setLiveStyle(e,p)}}}})};b.prototype.getValue=function(b){if(this.isInit){var d=ThemifyBuilderCommon.getComponentType(this.$liveStyledElmt);_.contains(["sub-col","col"],d)&&(d="column");return"module-inner"===d?
(d=a(this.style_tab).data("module"))&&this.data[d]&&this.data[d][b]?this.data[d][b]:!1:this.data[d]&&this.data[d][b]?this.data[d][b]:!1}return!1};b.prototype.bindModuleApppearance=function(){var b=this,c=function(d){return b.$context.find("#"+d+" > input:checked").map(function(b,d){return a(d).val()}).toArray().join(" ")},e={accordion_appearance_accordion:"> ul.ui.module-accordion",appearance_button:"> .ui.builder_button",appearance_callout:"",action_btn_appearance_callout:".callout-button a",according_style_menu:"ul.ui.nav:first",
mod_appearance_pricing_table:["","> .module-pricing-table-header",".module-pricing-table-button"]},g=Object.keys(e).reduce(function(a,b,d){0!==d&&(a+=",");return a+("#"+b+" > input")},"");b.$context.on("change",g,function(){var d=a(this).parent().attr("id"),f=e[d];Array.isArray(f)||(f=[f]);var g=a([]);f.forEach(function(a){g=""===a?g.add(b.$liveStyledElmt):g.add(b.$liveStyledElmt.find(a))});var f=b.getStylingVal(d).split("|").join(" "),h=c(d);"mod_appearance_pricing_table"===d&&(f+=" "+f.split(" ").join("|"),
h+=" "+h.split(" ").join("|"));g.removeClass(f).addClass(h);b.setStylingVal(d,c(d).split(" ").join("|"))})};b.prototype.bindLightboxForm=function(){this.bindChangesEvent();this.bindColors();this.bindTextInputs();this.bindBackgroundMode();this.bindBackgroundPosition();this.bindAnimation();this.bindBackgroundSlider();this.bindBackgroundTypeRadio();this.VideoOptions();this.overlayType();this.bindModuleLayout();this.bindModuleColor();this.bindModuleApppearance();this.bindModuleRadio();this.bindRowAnchor();
this.bindAdditionalCSSClass();this.bindRowWidthHeight()};b.prototype.resetStyling=function(){a("#background_repeat,#row_anchor,#custom_css_row,#custom_css_column,#add_css_text,#animation_effect,input[name=row_height],input[name=row_width]",this.$context).trigger("change");b.getComponentStyleTag(this.$liveStyledElmt).remove();this.addOrRemoveComponentOverlay("");this._removeAllLiveStyles()};b.getComponentBgOverlay=function(a){return a.children(".builder_row_cover")};b.getComponentBgSlider=function(a){return a.children(".row-slider, .col-slider, .sub-col-slider, .sub_row-slider")};
b.getComponentBgVideo=function(a){return a.children(".big-video-wrap")};b.getComponentStyleTag=function(a){var b=ThemifyBuilderCommon.getComponentType(a),d=null;"row"===b?d=a.find(".row_inner").children("style"):"col"===b?d=a.find(".tb-column-inner").children("style"):"subrow"===b?d=a.children("style"):"sub-col"===b?d=a.children("style"):"module-inner"===b&&(d=a.siblings("style"));return d};b.removeBgSlider=function(a){b.getComponentBgSlider(a).add(a.children(".backstretch")).remove();a.css({position:"",
background:"","z-index":""})};b.removeBgVideo=function(a){b.getComponentBgVideo(a).remove()};b.prototype._removeAllLiveStyles=function(){var a=this;this.getSpecialTextSelectors().concat(" a").forEach(function(b){e.remove(a.elmtSelector+b);a.frameJss&&a.frameJss.remove(a.elmtSelector+b)});a.selectorQueue.forEach(function(b){e.remove(b);a.frameJss&&a.frameJss.remove(b)});a.selectorQueue=[];e.remove(this.elmtSelector);a.frameJss&&a.frameJss.remove(this.elmtSelector);g.Frontend.responsiveFrame.doSync()};
b.prototype.remove=function(){this.isInit&&(this.currentStyleObj=this.$liveStyledElmt=null,this.isInit=!1)};b.toRGBA=function(a){a=a.split("_");var b=/^([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})$/;if("undefined"!==typeof a[0])return b=b.exec(a[0]),a="undefined"!==typeof a[1]?a[1]:1,b?"rgba("+parseInt(b[1],16)+", "+parseInt(b[2],16)+", "+parseInt(b[3],16)+", "+a+")":""};return b}(jQuery)})(jQuery);
