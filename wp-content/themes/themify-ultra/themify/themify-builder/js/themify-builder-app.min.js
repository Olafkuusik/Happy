...
{items:{},register:function(a,b){this.items[a]=b},lookup:function(a){return this.items[a]||null},remove:function(a){delete this.items[a]},destroy:function(){_.each(this.items,function(a,b){a.destroy()});this.items={};console.log("destroy registry")}};e.Models.setValue=function(a,b,d){d=d||!1;e.Models.Registry.lookup(a).set(b,{silent:d})};e.vent=_.extend({},Backbone.Events);e.Views.register_module=function(a,b){"default"!==a&&(this.Modules[a]=this.Modules["default"].extend(b))};e.Views.init_module=
function(a,b){b=b||"default";_.isUndefined(a.mod_settings)&&!_.isUndefined(themifyBuilder.modules[a.mod_name].defaults)&&(a.mod_settings=_.extend({},themifyBuilder.modules[a.mod_name].defaults));var c=a instanceof e.Models.Module?a:new e.Models.Module(a),f=new (this.get_module(b))({model:c,type:b});return{model:c,view:f}};e.Views.get_module=function(a){a=a||"default";return this.module_exists(a)?this.Modules[a]:this.Modules["default"]};e.Views.unregister_module=function(a){"default"!==a&&this.module_exists(a)&&
...
b))},_switchGridTabs:function(a){a.preventDefault();a.stopPropagation();var c=b(a.currentTarget),d=c.attr("href").replace("#","");if("module"===c.data("handle"))return!1;if("visual"!==e.mode){if(c.closest("li").hasClass("selected"))return!1;c.closest("ul").children("li.selected").removeClass("selected");c.closest("li").addClass("selected");c.closest(".grid_menu").find(".themify_builder_grid_tab").hide();c.closest(".grid_menu").find(".themify_builder_grid_tab.themify_builder_grid_"+d).show().find(".themify_builder_column_direction li.selected a").trigger("click")}else"tablet"===
d&&(d+="-landscape"),b(".js--themify_builder_breakpoint_switcher.breakpoint-"+d).trigger("click"),setTimeout(function(){var a=c.closest(".themify_builder_row").data("cid"),g=c.closest(".themify_builder_content").data("postid"),a="desktop"===d?b(".module_row_"+a,"#themify_builder_content-"+g):e.Frontend.responsiveFrame.$el.find("#themify_builder_content-"+g+" .module_row_"+a);b("html,body").animate({scrollTop:a.offset().top-b("#headerwrap.fixed-header").outerHeight(!0)-30},"fast")},1200)},_gridMenuClicked:function(a){a.preventDefault();
a.stopPropagation();var c=this,d=b(a.currentTarget),f=d.data("grid"),g=d.data("handle"),h=!1,k=d.closest("[data-postid]"),l=d.data("type"),t="desktop"===l;e.vent.trigger("dom:observer:start",k);d.closest(".themify_builder_grid_list").find(".selected").removeClass("selected");d.closest("li").addClass("selected");if("module"===g){if("-full"!==f[0]){var q=e.Views.init_subrow({cols:[{grid_class:"col-full"}]},this.type);var x=d.closest(".active_module"),v=x.clone();v.insertAfter(x);x.find(".grid_menu").remove();
var m=q.view.render().$el.find(".themify_module_holder").append(x).end().insertAfter(v).find("."+d.attr("class").replace(" ",".")).closest("li").addClass("selected").end().end().find(".themify_builder_sub_row_content");m.closest(".themify_builder_sub_row").find(".themify_builder_grid_"+l+":first .themify_builder_grid_list ."+l+f.join("-")).closest("li").addClass("selected");q=m.closest(".themify_builder_sub_row").find(".themify_builder_grid_tablet .themify_builder_grid_list li li,.themify_builder_grid_mobile .themify_builder_grid_list li li");
e.Utils.hideResponsiveCols(q,d.data("col"));v.remove()}}else{h="sub_row"===g;var p=d.closest(".themify_builder_"+g);m=p.find(".themify_builder_"+g+"_content")}"visual"!==e.mode||t||a.isTrigger||"module"===g||(v=m.closest(".themify_builder_content").data("postid"),b("#themify_builder_content-"+v).find(".module_"+g.replace("_","")+"_"+p.data("cid")+" .themify_builder_grid_"+l+":first .themify_builder_grid_list ."+l+f.join("-")).trigger("click"));if("module"!==g){var u=d.closest(".themify_builder_grid_list_wrapper");
var w=t?d.data("col"):u.find(".themify_builder_grid_desktop li.selected a").data("col");if(w){if(!t){k=parseInt(d.data("col"));var r=l+f.join("-");if("visual"===e.mode){a=r;if(2===k||3===k)a+=" "+l+"-"+(2===k?"2col":"3col");m.removeClass(l+"-2col "+l+"-3col tmp-mobile-auto "+p.attr("data-"+l)).addClass(a)}"tablet"===g&&e.Frontend.responsiveFrame.$el.find(".mobile-auto").removeClass("mobile-auto").addClass("tmp-mobile-auto");p.attr("data-"+l,r).data(l,r);return!1}a.isTrigger||(q=u.find(".themify_builder_grid_tablet .themify_builder_grid_list li li,.themify_builder_grid_mobile .themify_builder_grid_list li li"),
e.Utils.hideResponsiveCols(q,w),"visual"===e.mode&&(e.Utils.removeGridClass(m,"col-count"),m.removeClass("count-odd count-even").addClass("col-count-"+w+" count-"+(0===w%2?"even":"odd")),b.each(["tablet","mobile"],function(a,b){var c=u.find(".themify_builder_grid_"+b+" .themify_builder_grid_list li.selected"),d=0<c.length?u.find(".themify_builder_grid_"+b+" .themify_builder_grid_list li li").eq(w-1):!1;if(d&&"none"===c.css("display")&&"none"!==d.css("display")){c.removeClass("selected");d.addClass("selected");
d=d.children("a");c=parseInt(d.data("col"));d=d.data("grid");d=r=b+d.join("-");if(2===c||3===c)d+=" "+b+"-"+(2===c?"2col":"3col");m.removeClass(b+"-2col "+b+"-3col "+p.attr("data-"+b)).addClass(d);p.attr("data-"+b,r).data(b,r)}})))}}b.each(f,function(a,b){0<m.children(".themify_builder_col").eq(a).length?m.children(".themify_builder_col").eq(a).removeClass(e.Utils.clearClass).addClass("module_column col"+b):e.Utils._addNewColumn({newclass:(h?"sub_column module_column ":"")+"col"+b,component:h?"sub-column":
"column",type:c.type},m)});f.length<m.children().length&&m.children(".themify_builder_col").eq(f.length-1).nextAll().each(function(){var a=b(this).find(".themify_module_holder").first();a.find(".empty_holder_text").remove();a.children().appendTo(b(this).prev().find(".themify_module_holder").first());b(this).remove()});g=m.children();g.removeClass("first last");"visual"===e.mode&&m.hasClass(l+"-col-direction-rtl")||"visual"!==e.mode&&m.hasClass("direction-rtl")?(g.last().addClass("first"),g.first().addClass("last")):
...
"#FFF")):(d.find(k).each(function(){if(b(this).val()&&"solid"!==b(this).val())return l=!1}),l&&(b(this).prop("checked",!0),d.not(":last").hide(),f.children(".themify_builder_input").css("color","#FFF")));g.on("keyup",_.debounce(t,300));h.on("change",t)})},switchPlaceholdModule:function(a){a=a.parents(".themify_module_holder");1===a.find(".themify_builder_module").length&&a.find(".empty_holder_text").show()},getShortcodePreview:function(a,c){b.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tfb_load_shortcode_preview",
...
moduleEvents:function(){var a=this;this.$el.find(".row_menu .themify_builder_dropdown, .module_menu .themify_builder_dropdown").hide();this.$el.find(".themify_module_holder").each(function(){0<b(this).find(".active_module").length?b(this).find(".empty_holder_text").hide():b(this).find(".empty_holder_text").show()});var c=!1,d={placeholder:"themify_builder_ui_state_highlight",items:".active_module, .themify_builder_sub_row",connectWith:".themify_module_holder",cursor:"move",revert:100,tolerance:"pointer",
cursorAt:{top:20,left:110},beforeStart:function(d,f){e.vent.trigger("dom:observer:start",f.item.closest("[data-postid]"));"visual"===a.type&&(f.item.css("height",40),c=!0,b(this).sortable("refresh"))},sort:function(c,d){b(".themify_module_holder .themify_builder_ui_state_highlight").height(35);"visual"===a.type?(b(".themify_module_holder .themify_builder_sortable_helper").height(40).width(220),b("#themify_builder_module_panel").hasClass("slide_builder_module_state_down")||(b("#themify_builder_module_panel").addClass("slide_builder_module_state_down"),
e.Frontend.slidePanelOpen=!1,b("#themify_builder_module_panel").find(".slide_builder_module_panel_wrapper").slideUp())):d.item.css("width",220)},receive:function(c,d){a.placeHoldDragger();b(this).parent().find(".empty_holder_text").hide()},stop:function(d,f){if(f.item.hasClass("active_module")||f.item.hasClass("themify_builder_sub_row"))c&&(f.item.css("height",""),c=!1),f.item.hasClass("themify_builder_sub_row")&&f.item.parents(".themify_builder_sub_row").length&&(f.item.find(".active_module").clone().insertAfter(f.item),
f.item.remove()),0<b(".themify_module_holder .themify_builder_sortable_helper").length&&b(".themify_module_holder .themify_builder_sortable_helper").remove(),e.vent.trigger("dom:builder:change"),e.vent.trigger("dom:observer:end",f.item.closest("[data-postid]"));else{var g=e.Views.init_module({mod_name:f.item.data("module-slug")},a.type),h=g.view.render().$el;b(this).parent().find(".empty_holder_text").hide();f.item.replaceWith(h);g.view.trigger("edit",null,!0);g.view.trigger("custom:preview:init");
...
e.activeBreakPoint]=g;_.each(_.omit(themifyBuilder.breakpoints,e.activeBreakPoint),function(a,b){_.isUndefined(d["breakpoint_"+b])||(c["breakpoint_"+b]=d["breakpoint_"+b])})}else _.each(themifyBuilder.breakpoints,function(a,b){_.isUndefined(d["breakpoint_"+b])||(c["breakpoint_"+b]=d["breakpoint_"+b])});e.activeModel.set({mod_settings:{}},{silent:!0});e.activeModel.set({mod_settings:e.Utils.removeEmptyFields(c)});e.activeModel.trigger("custom:element:updatestate");ThemifyBuilderCommon.Lightbox.close();
e.vent.trigger("dom:observer:end",a,{cid:e.activeModel.cid,value:{mod_settings:e.activeModel.get("mod_settings")}});0<b(".mce-inline-toolbar-grp:visible").length&&b(".mce-inline-toolbar-grp:visible").hide();0<b(".tb-import-layout-button").length&&b(".tb-import-layout-button").remove()}},rowSaving:function(a){a.preventDefault();var c=b("#tfb_row_settings").themifySerializeObject(),d=e.activeModel.get("styling")||{};a={};var f=b(".current_selected_row").closest("[data-postid]");b("#tfb_row_settings").find(".themify_builder_row_js_wrapper").each(function(){var a=
b(this).attr("id"),d=e.Utils.getRepeaterValues(b(this));d&&(c[a]=d)});if("desktop"!==e.activeBreakPoint){var g=b("#themify_builder_row_fields_styling .tfb_lb_option").map(function(){return b(this).attr("id")}).get();a=_.pick(c,g);c=_.omit(c,g);c=_.extend(c,_.pick(d,g));c["breakpoint_"+e.activeBreakPoint]=a;_.each(_.omit(themifyBuilder.breakpoints,e.activeBreakPoint),function(a,b){_.isUndefined(d["breakpoint_"+b])||(c["breakpoint_"+b]=d["breakpoint_"+b])})}else _.each(themifyBuilder.breakpoints,function(a,
b){_.isUndefined(d["breakpoint_"+b])||(c["breakpoint_"+b]=d["breakpoint_"+b])});e.activeModel.set({styling:{}},{silent:!0});e.activeModel.set("styling",e.Utils.removeEmptyFields(c));ThemifyBuilderCommon.Lightbox.close();e.vent.trigger("dom:observer:end",f,{cid:e.activeModel.cid,value:{styling:e.activeModel.get("styling")}})},subRowSaving:function(a){a.preventDefault();var c=e.activeModel.get("styling")||{},d=b("#tfb_subrow_settings").themifySerializeObject();a={};var f=b(".current_selected_sub_row").closest("[data-postid]");
if("desktop"!==e.activeBreakPoint){var g=b("#tfb_subrow_settings .tfb_lb_option").map(function(){return b(this).attr("id")}).get();a=d;d=_.omit(d,g);d=_.extend(d,_.pick(c,g));d["breakpoint_"+e.activeBreakPoint]=a;_.each(_.omit(themifyBuilder.breakpoints,e.activeBreakPoint),function(a,b){_.isUndefined(c["breakpoint_"+b])||(d["breakpoint_"+b]=c["breakpoint_"+b])})}else _.each(themifyBuilder.breakpoints,function(a,b){_.isUndefined(c["breakpoint_"+b])||(d["breakpoint_"+b]=c["breakpoint_"+b])});e.activeModel.set({styling:{}},
{silent:!0});e.activeModel.set("styling",e.Utils.removeEmptyFields(d));ThemifyBuilderCommon.Lightbox.close();e.vent.trigger("dom:observer:end",f,{cid:e.activeModel.cid,value:{styling:e.activeModel.get("styling")}})},columnSaving:function(a){a.preventDefault();var c=e.activeModel.get("styling")||{},d=b("#tfb_column_settings").themifySerializeObject();a={};var f=b(".current_selected_column").closest("[data-postid]");if("desktop"!==e.activeBreakPoint){var g=b("#tfb_column_settings .tfb_lb_option").map(function(){return b(this).attr("id")}).get();
a=d;d=_.omit(d,g);d=_.extend(d,_.pick(c,g));d["breakpoint_"+e.activeBreakPoint]=a;_.each(_.omit(themifyBuilder.breakpoints,e.activeBreakPoint),function(a,b){_.isUndefined(c["breakpoint_"+b])||(d["breakpoint_"+b]=c["breakpoint_"+b])})}else _.each(themifyBuilder.breakpoints,function(a,b){_.isUndefined(c["breakpoint_"+b])||(d["breakpoint_"+b]=c["breakpoint_"+b])});e.activeModel.set("styling",e.Utils.removeEmptyFields(d));ThemifyBuilderCommon.Lightbox.close();e.vent.trigger("dom:observer:end",f,{cid:e.activeModel.cid,
value:{styling:e.activeModel.get("styling")}})},rowOptAddRow:function(a){var c=b(this).parent().prev(),d=e.cache.repeaterElements[c.attr("id")].clone(),f=b(".themify_builder_row_js_wrapper").find(".themify_builder_row:visible").length+1,g=f+Math.floor(9*Math.random());d.removeClass("collapsed").find(".themify_builder_row_content").show();d.find(".themify-builder-radio-dnd").each(function(a){var c=b(this).attr("name");b(this).attr({name:c+"_"+f,id:c+"_"+f+"_"+a}).not(":checked").prop("checked",!1).next("label").attr("for",
c+"_"+f+"_"+a)});d.find(".themify-layout-icon a").removeClass("selected");d.find(".thumb_preview").each(function(){b(this).find(".img-placeholder").html("").parent().hide()});d.find('input[type="text"], textarea').each(function(){b(this).val("")});d.find(".tfb_lb_wp_editor.tfb_lb_option_child").each(function(){var c=b(this).parents(".wp-editor-wrap").parent(),d=b(this).prop("id"),e=b(this).prop("name"),f=d+"_"+ThemifyBuilderCommon.randNumber(),d=c.html().replace(new RegExp(d,"g"),f),f=a.which?"newEditor":
"";c.html(d).find(".tfb_lb_wp_editor").prop("name",e).addClass(f)});d.find(".themify-builder-plupload-upload-uic").each(function(a){b(this).attr("id","pluploader_"+f+g+a+"themify-builder-plupload-upload-ui").addClass("plupload-clone").find('input[type="button"]').attr("id","pluploader_"+f+g+a+"themify-builder-plupload-browse-button")});d.find(".builderColorSelectInput").each(function(){var a=b(this),c=a.clone().val(""),d=a.closest(".themify_builder_field");a.prev().minicolors("destroy").removeAttr("maxlength");
d.find(".colordisplay").wrap('<div class="themify_builder_input" />').before('<span class="builderColorSelect"><span></span></span>').after(c);e.Utils.setColorPicker(d)});b(d).appendTo(c).show();a.which&&(b("#tfb_row_settings").find(".tfb_lb_wp_editor.tfb_lb_option_child.newEditor").each(function(a){e.Views.init_control("wp_editor",{el:b(this)});b(this).removeClass("newEditor")}),e.Utils.builderPlupload("new_elemn"));a.preventDefault()},moduleOptAddRow:function(a){var c=b(this).parent().prev(),d=
e.cache.repeaterElements[c.attr("id")].clone(),f=b(".themify_builder_row_js_wrapper").find(".tb_repeatable_field").length+1,g=f+Math.floor(9*Math.random());d.removeClass("collapsed").find(".themify_builder_row_content").show();d.find(".themify-builder-radio-dnd").each(function(a){var c=b(this).attr("name");b(this).prop({name:c+"_"+f,id:c+"_"+f+"_"+a,checked:!1}).next("label").attr("for",c+"_"+f+"_"+a);if(b(this).is("[data-checked]")){var d=b(this);b(this).prop("checked",!0);setTimeout(function(){d.trigger("change")},
100)}});d.find("[data-binding]").each(function(){var a=b(this).data("binding");try{var c="."+a.empty.hide.join(", .");d.find(c).children().hide()}catch(l){}});d.find(".themify-layout-icon a").removeClass("selected");d.find(".thumb_preview").each(function(){b(this).find(".img-placeholder").html("").parent().hide()});d.find("input[type=text], textarea").each(function(){b(this).val("")});d.find(".tfb_lb_wp_editor.tfb_lb_option_child").each(function(){var c=b(this).parents(".wp-editor-wrap").parent(),
...
b(d).appendTo(c).show();a.which&&(b("#tfb_module_settings").find(".tfb_lb_wp_editor.tfb_lb_option_child.newEditor").each(function(a){e.Views.init_control("wp_editor",{el:b(this)});b(this).removeClass("newEditor")}),e.Utils.builderPlupload("new_elemn"));a.preventDefault()},builderImportSubmit:function(a){a.preventDefault();var c=b(this);ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.dialog_import_page_post,function(a){b.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"builder_import_submit",
nonce:themifyBuilder.tfb_load_nonce,data:c.closest("form").serialize(),importType:"no"===a?"replace":"append",importTo:themifyBuilder.post_ID},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(a){ThemifyBuilderCommon.Lightbox.close();ThemifyBuilderCommon.showLoader("spinhide");window.location.reload()}})},{buttons:{no:{label:"Replace Existing Builder"},yes:{label:"Append Existing Builder"}}})},templateSelected:function(a){a.preventDefault();var c=b(this).closest(".layout_preview");
ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.confirm_template_selected,function(a){var d={type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"no"===a?"tfb_set_layout":"tfb_append_layout",nonce:themifyBuilder.tfb_load_nonce,layout_slug:c.data("slug"),current_builder_id:themifyBuilder.post_ID,layout_group:c.data("group")},success:function(a){ThemifyBuilderCommon.Lightbox.close();if("success"==a.status)if("visual"===e.mode)window.location.hash="#builder_active",window.location.reload();
else{var c=wp.autosave.getPostData();e.isPostSave=!0;!_.isUndefined(c.auto_draft)&&c.auto_draft&&(a=new e.Collections.Rows(a.builder_data),e.Instances.Builder[0]=new e.Views.Builder({el:"#themify_builder_row_wrapper",collection:a}),e.Instances.Builder[0].render());b(b("#save-post").length?"#save-post":"#publish").trigger("click")}else alert(a.msg)}};if("pre-designed"==c.data("group")){ThemifyBuilderCommon.showLoader("show");var g="https://themify.me/themify-layouts/"+c.data("slug")+".txt";b.get(g,
null,null,"text").done(function(a){d.data.builder_data=a;b.ajax(d)}).fail(function(a,b,c){ThemifyBuilderCommon.LiteLightbox.alert("There was an error in loading layout, please try again later, or you can download this file: ("+g+") and then import manually (http://themify.me/docs/builder#import-export).")}).always(function(){ThemifyBuilderCommon.showLoader()})}else b.ajax(d)},{buttons:{no:{label:"Replace Existing Layout"},yes:{label:"Append Existing Layout"}}})},saveAsLayout:function(a){a.preventDefault();
b.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tfb_save_custom_layout",nonce:themifyBuilder.tfb_load_nonce,form_data:b("#tfb_save_layout_form").serialize()},success:function(a){"success"===a.status?ThemifyBuilderCommon.Lightbox.close():alert(a.msg)}})},applyAll_events:function(a){a=b(this);var c=a.closest(".themify_builder_field").prevUntil("h4");if(a.prop("checked")){var d=!0;c.not(":last").slideUp(function(){d&&(c.last().find('input[type="text"], select').each(function(){var a=
...
breakpoint_switcher:function(a){a.preventDefault();var c=b(a.currentTarget),d="desktop";a=e.activeBreakPoint;c.hasClass("breakpoint-tablet")?d="tablet":c.hasClass("breakpoint-tablet-landscape")?d="tablet_landscape":c.hasClass("breakpoint-mobile")&&(d="mobile");if(a===d)return!1;"visual"===e.mode&&"desktop"===d&&b(".themify_builder_grid_"+d+" .themify_builder_column_direction li.selected a").trigger("click");e.activeBreakPoint=d;c.addClass("tb_selected").parent().siblings().find("a").removeClass("tb_selected");
