...
a.stopPropagation();console.log("paste");var c=b(a.currentTarget);a=ThemifyBuilderCommon.detectBuilderComponent(c);var e=ThemifyBuilderCommon.Clipboard.get(a);if(!1===e)ThemifyBuilderCommon.alertWrongPaste();else if(ThemifyBuilderCommon.confirmDataPaste()){var f=this.$el.closest("[data-postid]"),e=JSON.parse(e);d.vent.trigger("dom:observer:start",f,{cid:this.model.cid,value:this.model.toJSON()});if("column"===a||"sub-column"===a){var h=c.closest(".themify_builder_col"),g=c.closest("column"===a?".themify_builder_row":
".themify_builder_sub_row"),c=h.index(),g=g.index();e.column_order=c;e.grid_class=h.prop("class").replace("themify_builder_col","");"column"===a?e.row_order=g:(e.sub_row_order=g,e.row_order=h.closest(".themify_builder_row").index(),e.col_order=h.parents(".themify_builder_col").index());e.component_name=a}this.model.setData(e);d.vent.trigger("dom:builder:change");"visual"!==this.type&&d.vent.trigger("dom:observer:end",f,{cid:this.model.cid,value:this.model.toJSON()})}},"import":function(a){a.preventDefault();
...
h={data:{action:"tfb_exp_component_data_lightbox_options"}};switch(f){case "row":case "sub-row":var g=a.closest(".themify_builder_"+f.replace("-","_")),e=function(){var a=g.index(),a="row"===f?d.Utils._getRowSettings(g,a):d.Utils._getSubRowSettings(g,a);a.component_name=f;var a=JSON.stringify(a),e=b("#tfb_exp_"+f.replace("-","_")+"_data_field");e.val(a);c._autoSelectInputField(e);e.on("click",function(){c._autoSelectInputField(e)})};break;case "module":var k=a.closest(".active_module"),e=function(){var a=
k.data("mod-name"),e=JSON.parse(k.find(".themify_module_settings").find('script[type="text/json"]').text()),a=JSON.stringify({mod_name:a,mod_settings:e,component_name:"module"}),d=b("#tfb_exp_module_data_field");d.val(a);c._autoSelectInputField(d);d.on("click",function(){c._autoSelectInputField(d)})};break;case "column":case "sub-column":var g=a.closest("column"===f?".themify_builder_row":".themify_builder_sub_row"),l=a.closest(".themify_builder_col"),e=function(){var a=g.index(),a="column"===f?d.Utils._getRowSettings(g,
a):d.Utils._getSubRowSettings(g,a),e=l.index(),a=a.cols[e];a.component_name=f;var a=JSON.stringify(a),h=b("#tfb_exp_"+f.replace("-","_")+"_data_field");h.val(a);c._autoSelectInputField(h);h.on("click",function(){c._autoSelectInputField(h)})}}h.data.component=f;ThemifyBuilderCommon.Lightbox.open(h,e)},actionMenuHover:function(a){a.stopPropagation();var c=b(a.currentTarget);if("touchend"===a.type){a=c.closest(".themify_builder_row");var e=c.closest(".themify_builder_col"),d=c.closest(".themify_builder_module"),
h="row_"+a.index();0<e.length&&(h+="_col_"+e.index());0<d.length&&(h+="_mod_"+d.index());this.menuTouched[h]?(c.find(".themify_builder_dropdown").stop(!1,!0).hide(),a.css("z-index",""),ThemifyPageBuilder.menuTouched=[]):(e=this.$el,e.find(".themify_builder_dropdown").stop(!1,!0).hide(),e.find(".themify_builder_row").css("z-index",""),c.find(".themify_builder_dropdown").stop(!1,!0).show(),a.css("z-index","998"),this.menuTouched=[],this.menuTouched[h]=!0)}else"mouseenter"===a.type?c.find(".themify_builder_dropdown").stop(!1,
...
c){var e=!1;_.isNull(a)||_.isUndefined(a)?e=!0:(a.preventDefault(),this.model.set({styleClicked:b(a.currentTarget).hasClass("themify_builder_module_styling")},{silent:!0}));c=c||!1;d.activeModel=this.model;var f=this,h=this.model.get("mod_settings");b(".module_menu .themify_builder_dropdown").hide();this.highlightModuleBack(this.$el);c||d.vent.trigger("dom:observer:start",this.$el.closest("[data-postid]"),{cid:d.activeModel.cid,value:{mod_settings:d.activeModel.get("mod_settings")}});var g=function(a){a.setAttribute("data-form-state",
c?"new":"edit");if("desktop"!==d.activeBreakPoint){var g=b("#themify_builder_options_styling .tfb_lb_option").map(function(){return b(this).attr("id")}).get();h=_.omit(h,g);!_.isUndefined(h["breakpoint_"+d.activeBreakPoint])&&_.isObject(h["breakpoint_"+d.activeBreakPoint])&&(h=_.extend(h,h["breakpoint_"+d.activeBreakPoint]))}"visual"===f.type&&d.liveStylingInstance.init(f.$el.children(".module"),h);var k=a.getElementsByClassName("tfb_lb_option"),q,v=!_.isEmpty(h);for(q=0;q<k.length;++q){g=b(k[q]);
var p=g.attr("id");var m=h[p];g.hasClass("themify-gradient")?d.Utils.createGradientPicker(g,m):g.hasClass("tf-radio-input-container")&&g.find(":checked").trigger("change");if(m)if(g.hasClass("select_menu_field"))isNaN(m)?g.find("option[value='"+m+"']").attr("selected","selected"):g.find("option[data-termid='"+m+"']").attr("selected","selected");else if(g.is("select"))g.val(m).trigger("change");else if(g.hasClass("themify-builder-uploader-input")){p=m;var u=b("<img/>",{src:p,width:50,height:50});p?
(g.val(p),g.parent().find(".img-placeholder").empty().html(u).parent().show()):g.parent().find(".thumb_preview").hide()}else if(g.hasClass("themify-option-query-cat")){p=g.parent();var u=p.find(".query_category_multiple"),x=m.split("|")[0];p.find("option[value='"+x+"']").attr("selected","selected");u.val(x)}else if(g.hasClass("themify_builder_row_js_wrapper")){p=0;d.cache.repeaterElements[g.attr("id")]=g.find(".tb_repeatable_field").first().clone();0<m.length&&(p=m.length-1);for(u=0;u<p;u++)g.parent().find(".add_new a").first().trigger("click");
g.find(".tb_repeatable_field").each(function(a){b(this).find(".tfb_lb_option_child").each(function(c){c=b(this);var e=c.attr("id"),f=c.hasClass("tfb_lb_wp_editor")?c.attr("name"):c.data("input-id");f||(f=e);e=m[a][""+f+""];if(c.hasClass("themify-builder-uploader-input")){var g=b("<img/>",{src:e,width:50,height:50});e?(c.val(e),c.parent().find(".img-placeholder").empty().html(g).parent().show()):c.parent().find(".thumb_preview").hide()}else if(c.hasClass("tf-radio-choice"))c.find("input[value='"+e+
"']").attr("checked","checked").trigger("change");else if(c.hasClass("themify-layout-icon"))c.find("#"+e).addClass("selected");else if(c.hasClass("themify-checkbox"))for(g in e)c.find("input[value='"+e[g]+"']").prop("checked",!0);else c.is("input, textarea, select")&&c.val(e);c.hasClass("tfb_lb_wp_editor")&&d.Views.init_control("wp_editor",{el:c});c.data("control-binding")&&c.data("control-type")&&d.Views.init_control(c.data("control-type"),{el:c,binding_type:c.data("control-binding")})})})}else if(g.hasClass("tf-radio-input-container"))g.find("input[value='"+
m+"']").attr("checked","checked").trigger("change"),p=g.find('input[name="'+p+'"]:checked').val(),g.hasClass("tf-option-checkbox-enable")&&(g.find(".tf-group-element").hide(),g.find(".tf-group-element-"+p).show());else if(g.is('input[type!="checkbox"][type!="radio"], textarea'))g.val(m).trigger("change"),!c&&g.is("textarea")&&g.hasClass("tf-thumbs-preview")&&f.getShortcodePreview(g,m);else if(g.hasClass("themify-checkbox")){var w=m,w=w.split("|");g.find(".tf-checkbox").each(function(){b(this).prop("checked",
-1!==b.inArray(b(this).val(),w))})}else g.hasClass("themify-layout-icon")?g.find("#"+m).addClass("selected"):g.html(m);else g.hasClass("themify-layout-icon")?g.children().first().addClass("selected"):g.hasClass("themify-builder-uploader-input")?g.parent().find(".thumb_preview").hide():g.hasClass("tf-radio-input-container")?(g.find('input[type="radio"]').first().prop("checked"),p=g.find('input[name="'+p+'"]:checked').val(),g.hasClass("tf-option-checkbox-enable")&&(g.find(".tf-group-element").hide(),
g.find(".tf-group-element-"+p).show())):g.hasClass("themify_builder_row_js_wrapper")?(d.cache.repeaterElements[g.attr("id")]=g.find(".tb_repeatable_field").first().clone(),g.find(".tb_repeatable_field").each(function(a){b(this).find(".tfb_lb_option_child").each(function(a){a=b(this);a.hasClass("tfb_lb_wp_editor")&&d.Views.init_control("wp_editor",{el:a});a.data("control-binding")&&a.data("control-type")&&d.Views.init_control(a.data("control-type"),{el:a,binding_type:a.data("control-binding")})})})):
g.hasClass("themify-checkbox")&&v?g.find(".tf-checkbox").each(function(){b(this).prop("checked",!1)}):g.is('input[type!="checkbox"][type!="radio"], textarea')&&v&&g.val("");g.hasClass("tfb_lb_wp_editor")&&d.Views.init_control("wp_editor",{el:g});g.hasClass("themify_builder_row_js_wrapper")&&d.Views.init_control("repeater",{el:g,binding_type:g.data("control-binding")});g.data("control-binding")&&g.data("control-type")&&"repeater"!==g.data("control-type")&&d.Views.init_control(g.data("control-type"),
{el:g,binding_type:g.data("control-binding")})}b("body").trigger("editing_module_option",[h]);b(".tf-option-checkbox-enable input:checked").trigger("change");f.model.get("styleClicked")&&b('a[href="#themify_builder_options_styling"]').length&&b('a[href="#themify_builder_options_styling"]').trigger("click");e&&"gallery"===f.model.get("mod_name")&&b(".tf-gallery-btn",a).trigger("click");d.Utils.setColorPicker(a);d.Utils.builderPlupload("normal");f.moduleOptionsBinding();b(".themify_builder_tabs").tabs();
f.applyAll_init();ThemifyBuilderCommon.fontPreview(b("#themify_builder_lightbox_container"),h);"visual"===f.type&&(ThemifyBuilderCommon.Lightbox.rememberRow(f),d.liveStylingInstance.addStyleDate(f.model.get("mod_name"),themifyBuilder.element_style_rules[f.model.get("mod_name")]),d.styleSheet.rememberRules())};ThemifyBuilderCommon.highlightRow(this.$el.closest(".themify_builder_row"));ThemifyBuilderCommon.Lightbox.open({loadMethod:"inline",templateID:"builder_form_module_"+this.model.get("mod_name")},
function(a){setTimeout(function(){g(a)},400)})},"delete":function(a){a.preventDefault();confirm(themifyBuilder.i18n.moduleDeleteConfirm)&&(a=this.$el.closest("[data-postid]"),d.vent.trigger("dom:observer:start",a),this.switchPlaceholdModule(this.$el),this.model.destroy(),d.vent.trigger("dom:observer:end",a),d.vent.trigger("dom:builder:change"))},duplicate:function(a){a.preventDefault();a=d.Views.init_module(this.model.toJSON(),this.type);var b=this.$el.closest("[data-postid]");d.vent.trigger("dom:observer:start",
...
{},e=this.model.get("col_tablet"),f=this.model.get("col_mobile"),h=this.$el.find(".themify_builder_sub_row_content");c.desktop=this.model.get("desktop_dir");c.tablet=this.model.get("tablet_dir");c.mobile=this.model.get("mobile_dir");e||(e="tablet-auto");f||(f="mobile-auto");c.desktop||(c.desktop="ltr");c.tablet||(c.tablet="ltr");c.mobile||(c.mobile="ltr");var g=this.$el;b.each(c,function(a,b){"ltr"!==b&&g.find(".themify_builder_grid_"+a+" .themify_builder_column_direction").first().find("li").removeClass("selected").children(".column-dir-"+
b).parent().addClass("selected")});"visual"===d.mode?h.removeClass("desktop-col-direction-ltr desktop-col-direction-rtl tablet-col-direction-ltr tablet-col-direction-rtl mobile-col-direction-ltr mobile-col-direction-rtl").addClass("tfb_grid_classes desktop-col-direction-"+c.desktop+" tablet-col-direction-"+c.tablet+" mobile-col-direction-"+c.mobile):h.addClass("direction-"+c.desktop);var c=this.$el.find(".themify_builder_grid_mobile ."+f).first(),k=this.$el.find(".themify_builder_grid_tablet ."+e).first(),
l=parseInt(c.data("col")),r=parseInt(k.data("col"));c.closest("li").addClass("selected");k.closest("li").addClass("selected");if(2===l||3===l)f+=" mobile-"+(2===l?"2col":"3col");if(2===r||3===r)e+=" tablet-"+(2===r?"2col":"3col");h.addClass(this.model.get("gutter")+" "+f+" "+e);return this},renderInlineData:function(){var a=this.model.get("styling"),b="",e="",d="";_.isObject(a)&&(b=_.isEmpty(a.background_video)||"video"!==a.background_type?"":a.background_video)&&!_.isEmpty(a.background_video_options)&&
...
_.each(this.model.get("cols"),function(b,c){b.component_name="column";_.isObject(b.styling)&&(b.styling=d.Utils.removeEmptyFields(b.styling));var e=d.Views.init_column(b,this.type);a.appendChild(e.view.render().el)},this);this.$el.find(".themify_builder_row_content").append(a)}setTimeout(function(){d.Mixins.Builder._selectedGridMenu(this.$el)}.bind(this),100);var c={},e=this.model.get("col_tablet"),f=this.model.get("col_mobile"),h=this.$el.find(".themify_builder_row_content");c.desktop=this.model.get("desktop_dir");
c.tablet=this.model.get("tablet_dir");c.mobile=this.model.get("mobile_dir");e||(e="tablet-auto");f||(f="mobile-auto");c.desktop||(c.desktop="ltr");c.tablet||(c.tablet="ltr");c.mobile||(c.mobile="ltr");var g=this.$el;b.each(c,function(a,b){"ltr"!==b&&g.find(".themify_builder_grid_"+a+" .themify_builder_column_direction").first().find("li").removeClass("selected").children(".column-dir-"+b).parent().addClass("selected")});"visual"===d.mode?h.removeClass("desktop-col-direction-ltr desktop-col-direction-rtl tablet-col-direction-ltr tablet-col-direction-rtl mobile-col-direction-ltr mobile-col-direction-rtl").addClass("tfb_grid_classes desktop-col-direction-"+
c.desktop+" tablet-col-direction-"+c.tablet+" mobile-col-direction-"+c.mobile):h.addClass("direction-"+c.desktop);var c=this.$el.find(".themify_builder_grid_mobile ."+f).first(),k=this.$el.find(".themify_builder_grid_tablet ."+e).first(),l=parseInt(c.data("col")),r=parseInt(k.data("col"));c.closest("li").addClass("selected");k.closest("li").addClass("selected");if(2===l||3===l)f+=" mobile-"+(2===l?"2col":"3col");if(2===r||3===r)e+=" tablet-"+(2===r?"2col":"3col");h.addClass(this.model.get("gutter")+
...
""),setTimeout(function(){c.find(".gutter_select").trigger("change")}))});return c[0]},renderInlineData:function(){var a="",b="",e="",d="",h=this.model.get("styling");this.$el.find(".row-data-styling").attr("data-styling",JSON.stringify(h));_.isObject(h)&&(a=_.isEmpty(h.row_anchor)?"":"#"+h.row_anchor,(b=_.isEmpty(h.background_video)||"video"!==h.background_type?"":h.background_video)&&!_.isEmpty(h.background_video_options)&&(e=-1!==h.background_video_options.indexOf("mute")?"mute":"",d=-1!==h.background_video_options.indexOf("unloop")?
...
e&&(e+="-landscape"),b(".js--themify_builder_breakpoint_switcher.breakpoint-"+e).trigger("click"),setTimeout(function(){var a=c.closest(".themify_builder_row").data("cid"),h=c.closest(".themify_builder_content").data("postid"),a="desktop"===e?b(".module_row_"+a,"#themify_builder_content-"+h):d.Frontend.responsiveFrame.$el.find("#themify_builder_content-"+h+" .module_row_"+a);b("html,body").animate({scrollTop:a.offset().top-b("#headerwrap.fixed-header").outerHeight(!0)-30},"fast")},1200)},_gridMenuClicked:function(a){a.preventDefault();
a.stopPropagation();var c=this,e=b(a.currentTarget),f=e.data("grid"),h=e.data("handle"),g=!1,k=e.closest("[data-postid]"),l=e.data("type"),r="desktop"===l;d.vent.trigger("dom:observer:start",k);e.closest(".themify_builder_grid_list").find(".selected").removeClass("selected");e.closest("li").addClass("selected");if("module"===h){if("-full"!==f[0]){var q=d.Views.init_subrow({cols:[{grid_class:"col-full"}]},this.type);var v=e.closest(".active_module"),p=v.clone();p.insertAfter(v);v.find(".grid_menu").remove();
...
e=e.children("a");c=parseInt(e.data("col"));e=e.data("grid");e=t=b+e.join("-");if(2===c||3===c)e+=" "+b+"-"+(2===c?"2col":"3col");m.removeClass(b+"-2col "+b+"-3col "+u.attr("data-"+b)).addClass(e);u.attr("data-"+b,t).data(b,t)}})))}}b.each(f,function(a,b){0<m.children(".themify_builder_col").eq(a).length?m.children(".themify_builder_col").eq(a).removeClass(d.Utils.clearClass).addClass("module_column col"+b):d.Utils._addNewColumn({newclass:(g?"sub_column module_column ":"")+"col"+b,component:g?"sub-column":
"column",type:c.type},m)});f.length<m.children().length&&m.children(".themify_builder_col").eq(f.length-1).nextAll().each(function(){var a=b(this).find(".themify_module_holder").first();a.find(".empty_holder_text").remove();a.children().appendTo(b(this).prev().find(".themify_module_holder").first());b(this).remove()});h=m.children();h.removeClass("first last");"visual"===d.mode&&m.hasClass(l+"-col-direction-rtl")||"visual"!==d.mode&&m.hasClass("direction-rtl")?(h.last().addClass("first"),h.first().addClass("last")):
(h.first().addClass("first"),h.last().addClass("last"));var n=!1;g&&"-full"===f[0]&&(n=m.find(".active_module"),l=m.closest(".themify_builder_row"),n.insertAfter(e.closest(".themify_builder_sub_row")),e.closest(".themify_builder_sub_row").remove(),"visual"===d.mode&&"desktop"!==d.activeBreakPoint&&d.Mixins.Builder.initGridMenu(l));setTimeout(function(){var a=g&&n?n.find(".themify_builder_grid_list"):e.closest(".themify_builder_grid_list");"-full"===f[0]?(a.find("a:first").parent().addClass("selected"),
a.nextAll(".themify_builder_column_alignment").find("a:first").trigger("click"),a.nextAll(".gutter_select").val("gutter-default").trigger("change"),a.nextAll().hide()):a.nextAll().show()},100);d.Utils.columnDrag(m,!0);d.vent.trigger("dom:observer:end",k);d.vent.trigger("dom:builder:change")},_columnAlignmentMenuClicked:function(a){a.preventDefault();a.stopPropagation();var c=b(a.currentTarget),e=c.data("handle"),f=c.data("alignment");if("module"!==e&&(a.isTrigger||!c.closest("li").hasClass("selected"))){if(a.which){var h=
c.closest("[data-postid]");d.vent.trigger("dom:observer:start",h)}c.closest(".themify_builder_column_alignment").find(".selected").removeClass("selected");c.closest("li").addClass("selected");c=c.closest(".themify_builder_"+e);c.data("column-alignment",f);"visual"===this.type&&c.removeClass(themifyBuilder.columnAlignmentClass).addClass(f);a.which&&d.vent.trigger("dom:observer:end",h)}},_columnDirectionMenuClicked:function(a){a.preventDefault();a.stopPropagation();var c=b(a.currentTarget);var e=c.data("handle"),
f=c.data("dir"),h=c.data("type"),g="module"===e?!1:c.closest(".themify_builder_"+e).find(".themify_builder_"+e+"_content");if("module"!==e&&(a.isTrigger||f!==g.data(h+"-dir")&&!c.closest("li").hasClass("selected"))){if(a.which){var k=c.closest("[data-postid]");d.vent.trigger("dom:observer:start",k)}var l="";c.closest(".themify_builder_column_direction").find(".selected").removeClass("selected");c.closest("li").addClass("selected");g.removeClass("tablet-direction-selected mobile-direction-selected desktop-direction-selected").addClass(h+
"-direction-selected").closest("[data-cid]").data(h+"_dir",f);"visual"===d.mode?(g.removeClass(h+"-col-direction-ltr "+h+"-col-direction-rtl").addClass(h+"-col-direction-"+f),c=a.isTrigger&&"desktop"!==d.activeBreakPoint&&"desktop"===h,"desktop"===d.activeBreakPoint||a.isTrigger||(l=g.closest(".themify_builder_content").data("postid"),e="sub_row"===e?g.closest(".themify_builder_sub_row").data("cid"):g.closest(".themify_builder_row").data("cid"),b("#themify_builder_content-"+l).find('[data-cid="'+
e+'"]').find(".themify_builder_grid_"+h+":first .themify_builder_column_direction  .column-dir-"+f).trigger("click")),l="tablet_landscape"===d.activeBreakPoint?"tablet":d.activeBreakPoint):(g.removeClass("direction-rtl direction-ltr").addClass("direction-"+f),c=!0);if(c||h===l)h=g.children(".themify_builder_col"),g=h.first(),c=h.last(),h.removeClass("first last"),"rtl"===f?(g.addClass("last"),c.addClass("first")):(g.addClass("first"),c.addClass("last"));a.which&&d.vent.trigger("dom:observer:end",
...
b(this).attr("id"))});b(".tfb_lb_option.themify-layout-icon a.selected",c).trigger("click")},applyAll_init:function(){var a=this;b(".style_apply_all").each(function(){var c=b(this).val(),e=b(this).closest(".themify_builder_field").prevUntil("h4"),f=e.last(),h=f.find('input[type="text"]').not(".colordisplay"),g=f.find("select"),k="border"===c?'[name="border_top_color"], [name="border_top_width"], [name="border_top_style"], [name="border_right_color"], [name="border_right_width"], [name="border_right_style"], [name="border_bottom_color"], [name="border_bottom_width"], [name="border_bottom_style"], [name="border_left_color"], [name="border_left_width"], [name="border_left_style"]':
'[name="'+c+'_top"], [name="'+c+'_right"], [name="'+c+'_bottom"], [name="'+c+'_left"]',l=!0,r=function(g){if(e.first().next(".themify_builder_field").find(".style_apply_all").is(":checked")){var h=b(this).val(),k=!1,l=b(this).is("select");e.not(":last").each(function(){l?(k=b(this).find("select option").prop("selected",!1).filter('[value="'+h+'"]'),k.prop("selected",!0),"border"!==c&&k.trigger("change")):(k=b(this).find('input[type="text"].tfb_lb_option'),k.val(h),"border"!==c&&k.trigger("keyup"))});
k&&"border"===c&&"visual"===a.type&&(d.liveStylingInstance.setApplyBorder(l?k.closest("select").prop("name"):k.prop("name"),h,l?"style":"width"),l?f.find('input[type="text"].colordisplay').trigger("blur"):(g=f.find(".colordisplay, .style_border").map(function(){return this.value||null}).get(),_.isEmpty(g)?d.liveStylingInstance.setApplyBorder(f.find("select").prop("name"),"","style"):f.find("select").trigger("change")))}};b(this).is(":checked")?(e.not(":last").hide(),f.children(".themify_builder_input").css("color",
"#FFF")):(e.find(k).each(function(){if(b(this).val()&&"solid"!==b(this).val())return l=!1}),l&&(b(this).prop("checked",!0),e.not(":last").hide(),f.children(".themify_builder_input").css("color","#FFF")));h.on("keyup",_.debounce(r,300));g.on("change",r)})},switchPlaceholdModule:function(a){a=a.parents(".themify_module_holder");1===a.find(".themify_builder_module").length&&a.find(".empty_holder_text").show()},getShortcodePreview:function(a,c){b.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tfb_load_shortcode_preview",
...
a||document;b(".grid_menu",a).each(function(){var a=b(this).data("handle"),e=[];if("module"!==a){a=b(this).closest(".themify_builder_"+a).find(".themify_builder_"+a+"_content");a.children().each(function(){e.push(d.Utils._getColClass(b(this).prop("class").split(" ")))});var f=b(this).find(".themify_builder_grid_desktop .grid-layout-"+e.join("-")),h=f.data("col");f.closest("li").addClass("selected");var g=b(this).find(".themify_builder_grid_desktop .themify_builder_grid_list"),k=f.data("grid");k&&
"-full"===k[0]?(g.nextAll(".themify_builder_column_alignment").find("a:first").trigger("click"),g.nextAll(".gutter_select").val("gutter-default").trigger("change"),g.nextAll().hide()):g.nextAll().show();g=b(this).find(".themify_builder_grid_tablet .themify_builder_grid_list li li,.themify_builder_grid_mobile .themify_builder_grid_list li li");d.Utils.hideResponsiveCols(g,h);f.data("col")&&a.addClass("col-count-"+h+" count-"+(0===h%2?"even":"odd"))}})},makeEqual:function(a,c){a.each(function(){var a=
...
d.cache.repeaterElements[c.attr("id")].clone(),f=b(".themify_builder_row_js_wrapper").find(".themify_builder_row:visible").length+1,h=f+Math.floor(9*Math.random());e.removeClass("collapsed").find(".themify_builder_row_content").show();e.find(".themify-builder-radio-dnd").each(function(a){var c=b(this).attr("name");b(this).attr({name:c+"_"+f,id:c+"_"+f+"_"+a}).not(":checked").prop("checked",!1).next("label").attr("for",c+"_"+f+"_"+a)});e.find(".themify-layout-icon a").removeClass("selected");e.find(".thumb_preview").each(function(){b(this).find(".img-placeholder").html("").parent().hide()});
...
b(b("#save-post").length?"#save-post":"#publish").trigger("click")}else alert(a.msg)}};if("pre-designed"==c.data("group")){ThemifyBuilderCommon.showLoader("show");var h="https://themify.me/themify-layouts/"+c.data("slug")+".txt";b.get(h,null,null,"text").done(function(a){e.data.builder_data=a;b.ajax(e)}).fail(function(a,b,c){ThemifyBuilderCommon.LiteLightbox.alert("There was an error in loading layout, please try again later, or you can download this file: ("+h+") and then import manually (http://themify.me/docs/builder#import-export).")}).always(function(){ThemifyBuilderCommon.showLoader()})}else b.ajax(e)},
...
b('[data-cid="'+d.activeModel.cid+'"]').closest("[data-postid]");d.vent.trigger("dom:observer:start",e,{cid:d.activeModel.cid,value:d.activeModel.toJSON()});c=c.find("#tfb_imp_"+a.replace("-","_")+"_data_field");c=JSON.parse(c.val());if(c.hasOwnProperty("component_name")&&c.component_name===a){if("column"===a||"sub-column"===a){var f=b(".current_selected_column"),h=f.closest("column"===a?".themify_builder_row":".themify_builder_sub_row").index(),g=f.index();c.column_order=g;c.grid_class=f.prop("class").replace("themify_builder_col",
"");"column"===a?c.row_order=h:(c.sub_row_order=h,c.row_order=f.closest(".themify_builder_row").index(),c.col_order=f.parents(".themify_builder_col").index())}ThemifyBuilderCommon.Lightbox.close();d.activeModel.setData(c);d.vent.trigger("dom:builder:change");"visual"!==d.mode&&d.vent.trigger("dom:observer:end",e,{cid:d.activeModel.cid,value:d.activeModel.toJSON()})}else ThemifyBuilderCommon.alertWrongPaste()},moduleActions:function(){b("body").on("change",".module-widget-select-field",function(){var a=
...
var c=this,e={};a.find("[data-validation]").each(function(){var a=b(this),d=b(this).data("validation"),g="";a.is("select, input, textarea")&&(g=a.val());c.checkValidate(d,g)||(e[a.prop("id")]=a.data("error-msg"))});a.find(".tb_field_error").removeClass("tb_field_error").end().find(".tb_field_error_msg").remove();if(_.isEmpty(e))return!0;_.each(e,function(a,c){var e=b("#"+c);e.addClass("tb_field_error");b("<span/>",{"class":"tb_field_error_msg","data-error-key":c}).text(a).insertAfter(e)});return!1},
...
"click .js--themify_builder_breakpoint_switcher":"breakpoint_switcher"},initialize:function(){var a=this,c=b("body"),e=b("html,body"),f="",h=wp.template("builder_module_item_draggable");_.each(_.sortBy(themifyBuilder.modules,"name"),function(a,b){f+=h({slug:a.slug,name:a.name})});this.$(".tb_module_panel_modules_wrap").html(f);this.$(".themify_builder_module").draggable({appendTo:"body",helper:"clone",revert:"invalid",connectToSortable:".themify_module_holder",cursorAt:{top:10,left:40},drag:function(b,
...
("tablet_landscape"===e?"tablet":e)+" .themify_builder_column_direction li.selected a").trigger("click"),b(".themify_builder_workspace_container").addClass("onshow"),b(".themify_builder_site_canvas").animate({width:d.Utils.getBPWidth(e)-1},800,function(){"mobile"!==e?d.Frontend.responsiveFrame.$el.find(".mobile-auto").removeClass("mobile-auto").addClass("tmp-mobile-auto"):d.Frontend.responsiveFrame.$el.find(".tmp-mobile-auto").removeClass("tmp-mobile-auto").addClass("mobile-auto");setTimeout(function(){document.body.style.height=
d.Frontend.responsiveFrame.contentWindow.document.body.scrollHeight+"px"},500);d.Frontend.responsiveFrame.contentWindow.scrollTo(0,b(window).scrollTop())}),this._disable_module_panel()))},_hide_module_panel:function(){this.is_locked||this.$("#tb_module_panel").hasClass("tb_module_panel_show")&&this.$("#tb_module_panel").removeClass("tb_module_panel_show")},_show_module_panel:function(){this.is_locked||this.$("#tb_module_panel").hasClass("tb_module_panel_show")||this.$("#tb_module_panel").addClass("tb_module_panel_show")},
_disable_module_panel:function(){this._set_panel_lock(!1);this.$(".tb_toolbar_add_modules").addClass("tb_disabled");this.$(".tb_module_panel_lock").removeClass("tb_locked");"visual"===d.mode&&b("body").removeClass("tb_module_panel_locked");this._hide_module_panel()},reopen_module_panel:!1,_hide_distraction_module_panel:function(){this.$("#tb_module_panel").hasClass("tb_module_panel_show")?(this.$("#tb_module_panel").removeClass("tb_module_panel_show"),this.is_locked&&b("body").removeClass("tb_module_panel_locked"),
this.reopen_module_panel=!0):this.reopen_module_panel=!1},_show_distraction_module_panel:function(){!this.$("#tb_module_panel").hasClass("tb_module_panel_show")&&this.reopen_module_panel&&(this.$("#tb_module_panel").addClass("tb_module_panel_show"),this.is_locked&&b("body").addClass("tb_module_panel_locked"),this.reopen_module_panel=!1)}});d.Views.bindEvents=function(){ThemifyBuilderCommon.setupLoader();ThemifyBuilderCommon.Lightbox.setup();ThemifyBuilderCommon.LiteLightbox.modal.on("attach",function(){this.$el.addClass("themify_builder_lite_lightbox_modal")});
d.Utils.setupTooltips();d.Utils.mediaUploader();d.Utils.openGallery()};d.Utils={clearClass:"col6-1 col5-1 col4-1 col4-2 col4-3 col3-1 col3-2 col2-1 col-full",gridClass:"col-full col4-1 col4-2 col4-3 col3-1 col3-2 col6-1 col5-1".split(" "),tfb_hidden_editor_object:null,_addNewColumn:function(a,b){var c=d.Views.init_column({grid_class:a.newclass,component_name:a.component},a.type);b.append(c.view.render().$el)},removeGridClass:function(a,b){b=b.split(",");for(var c=a.prop("class").replace(/ +(?= )/g,
"").split(" "),d=0;d<c.length;d++)for(var h=0;h<b.length;h++)-1!==c[d].indexOf(b[h])&&-1===c[d].indexOf("col-direction")&&a.removeClass(c[d])},removeEmptyFields:function(a){return a},hideResponsiveCols:function(a,c){if(c){c=parseInt(c);var e=0===c%2;a.hide().each(function(){var a=parseInt(b(this).children("a").data("col"));a===c||1===a||e&&0===c%a?b(this).show():!e&&c>a&&(5===c&&(2===a||3===a)||3===c&&2===a)&&b(this).show()});var d=a.first().closest(".themify_builder_grid_list_wrapper").find(".themify_builder_column_direction");
1===c?d.hide():d.show()}},filterClass:function(a){var c=this.gridClass.concat(["first","last"]);a=a.split(" ");for(var e=[],d=0;d<a.length;d++)-1<b.inArray(a[d],c)&&e.push(a[d]);return e.join(" ")},_getRowSettings:function(a,c){var e=this,f={},h={};a.find(".themify_builder_row_content").children(".themify_builder_col").each(function(a){var c=e.filterClass(b(this).attr("class")),f={};b(this).find(".themify_module_holder").first().children().each(function(a){if(b(this).hasClass("active_module")){var c=
b(this).data("cid"),c=d.Models.Registry.lookup(c);f[a]={mod_name:c.get("mod_name"),mod_settings:c.get("mod_settings")}}b(this).hasClass("themify_builder_sub_row")&&(f[a]=e._getSubRowSettings(b(this),a))});h[a]={column_order:a,grid_class:c,modules:f};b(this).prop("style").width&&(h[a].grid_width=parseFloat(b(this).prop("style").width));0<b(this).children(".column-data-styling").length&&(c=b.parseJSON(b(this).children(".column-data-styling").attr("data-styling")),"object"===typeof c&&(h[a].styling=
c))});f={row_order:c,cols:h};"gutter-default"!==a.data("gutter")&&(f.gutter=a.data("gutter"));"col_align_top"!==a.data("column-alignment")&&(f.column_alignment=a.data("column-alignment"));"ltr"!==a.data("desktop_dir")&&(f.desktop_dir=a.data("desktop_dir"));"ltr"!==a.data("tablet_dir")&&(f.tablet_dir=a.data("tablet_dir"));"ltr"!==a.data("mobile_dir")&&(f.mobile_dir=a.data("mobile_dir"));"tablet-auto"!==b.trim(a.data("tablet"))&&(f.col_tablet=b.trim(a.data("tablet")));"mobile-auto"!==b.trim(a.data("mobile"))&&
(f.col_mobile=b.trim(a.data("mobile")));if(0<a.find(".row-data-styling").length){var g=b.parseJSON(a.find(".row-data-styling").attr("data-styling"));"object"===typeof g&&(f.styling=g)}return f},_getSubRowSettings:function(a,c){var e=this,f={},h={};a.find(".themify_builder_col").each(function(a){var c=e.filterClass(b(this).attr("class")),f={};b(this).find(".active_module").each(function(a){var c=b(this).data("cid"),c=d.Models.Registry.lookup(c);f[a]={mod_name:c.get("mod_name"),mod_settings:c.get("mod_settings")}});
h[a]={column_order:a,grid_class:c,modules:f};b(this).prop("style").width&&(h[a].grid_width=parseFloat(b(this).prop("style").width));0<b(this).children(".column-data-styling").length&&(c=b.parseJSON(b(this).children(".column-data-styling").attr("data-styling")),"object"===typeof c&&(h[a].styling=c))});f={row_order:c,cols:h};"gutter-default"!==a.data("gutter")&&(f.gutter=a.data("gutter"));"col_align_top"!==a.data("column-alignment")&&(f.column_alignment=a.data("column-alignment"));"ltr"!==a.data("desktop_dir")&&
(f.desktop_dir=a.data("desktop_dir"));"ltr"!==a.data("tablet_dir")&&(f.tablet_dir=a.data("tablet_dir"));"ltr"!==a.data("mobile_dir")&&(f.mobile_dir=a.data("mobile_dir"));"tablet-auto"!==b.trim(a.data("tablet"))&&(f.col_tablet=b.trim(a.data("tablet")));"mobile-auto"!==b.trim(a.data("mobile"))&&(f.col_mobile=b.trim(a.data("mobile")));if(0<a.find(".subrow-data-styling").length){var g=b.parseJSON(a.find(".subrow-data-styling").attr("data-styling"));"object"===typeof g&&(f.styling=g)}return f},builderPlupload:function(a){a=
b(".themify-builder-plupload-upload-uic"+("new_elemn"===a?".plupload-clone":""));if(0<a.length){var c=!1;a.each(function(){var a=b(this),d=a.attr("id").replace("themify-builder-plupload-upload-ui","");c=JSON.parse(JSON.stringify(themify_builder_plupload_init));c.browse_button=d+c.browse_button;c.container=d+c.container;c.drop_element=d+c.drop_element;c.file_data_name=d+c.file_data_name;c.multipart_params.imgid=d;c.multipart_params._ajax_nonce=themifyBuilder.tfb_load_nonce;c.multipart_params.topost=
themifyBuilder.post_ID;a.data("extensions")&&(c.filters[0].extensions=a.data("extensions"));d=new plupload.Uploader(c);d.bind("Init",function(a){});d.init();d.bind("FilesAdded",function(a,c){a.refresh();a.start();b("#themify_builder_alert").addClass("busy").show()});d.bind("Error",function(a,c){var e=b(".prompt-box .show-error");b(".prompt-box .show-login").hide();e.show();0<e.length&&e.html('<p class="prompt-error">'+c.message+"</p>");b(".overlay, .prompt-box").fadeIn(500)});d.bind("FileUploaded",
function(c,e,d){c=JSON.parse(d.response);var f="200"!=d.status||c.error?"error":"done";b("#themify_builder_alert").removeClass("busy").addClass(f).delay(800).fadeOut(800,function(){b(this).removeClass(f)});c.error?alert(c.error):(d=c.large_url?c.large_url:c.url,e=c.id,c=c.thumb,a.closest(".themify_builder_input").find(".themify-builder-uploader-input").val(d).trigger("change").parent().find(".img-placeholder").empty().html(b("<img/>",{src:c,width:50,height:50})).parent().show(),a.closest(".themify_builder_input").find(".themify-builder-uploader-input-attach-id").val(e))});
a.removeClass("plupload-clone")})}},columnDrag:function(a,c,e,f){c&&(a?a.children(".themify_builder_col").css("width",""):b(".themify_builder_col").css("width",""));var h=this;c=a?a.children(".themify_builder_col").find(".themify_grid_drag"):b(".themify_grid_drag");var g=c.first().closest("[data-postid]"),k={"col6-1":14,"col5-1":17.44,"col4-1":22.6,"col4-2":48.4,"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},l={"col6-1":15.33,"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,
"col3-1":32.266,"col3-2":66.05},r={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,"col3-2":66.666};if(e&&f){a=a.children(".themify_builder_col");var q=("gutter-narrow"===e?1.6:"gutter-none"===e?0:3.2)-("gutter-narrow"===f?1.6:"gutter-none"===f?0:3.2),q=parseFloat(q*(a.length-1)/a.length);a.each(function(a){b(this).prop("style").width&&(a=parseFloat(b(this).prop("style").width)+q,b(this).css("width",a+"%"))})}else c.each(function(){var a=b(this),c=a.closest(".themify_builder_sub_row_content"),
c=0===c.length?a.closest(".themify_builder_row_content"):c,e=c.children(".themify_builder_col"),f=a.closest(".themify_builder_col"),q=0,n=a.hasClass("themify_drag_right")?"w":"e",t=!1,A=0,B="w"===n?"themify_grid_drag_placeholder_right":"themify_grid_drag_placeholder_left",y,z,C,n=a.hasClass("themify_drag_right")?"w":"e";a.draggable({axis:"x",cursor:"col-resize",distance:0,containment:".themify_builder_row_content",helper:function(a){return b('<div class="ui-widget-header themify_grid_drag_placeholder '+
B+'"></div><div class="ui-widget-header themify_grid_drag_placeholder"></div>')},start:function(b,e){d.vent.trigger("dom:observer:start",g);z="rtl"===c.closest("[data-cid]").data(d.activeBreakPoint+"_dir");"w"===n?(t=z?f.prev(".themify_builder_col"):f.next(".themify_builder_col"),q=a.outerWidth()):(t=z?f.next(".themify_builder_col"):f.prev(".themify_builder_col"),q=f.outerWidth());A=t.outerWidth()-2;C=e.position.left;y=c.outerWidth()},stop:function(a,q){b(".themify_grid_drag_placeholder").remove();
d.vent.trigger("dom:observer:end",g);var m=Math.ceil(100*(f.outerWidth()/y));f.css("width",m+"%");var p=k,m=3.2;c.hasClass("gutter-narrow")?(p=l,m=1.6):c.hasClass("gutter-none")&&(p=r,m=0);var n=m*(e.length-1);e.each(function(a){a!==t.index()&&(b(this).prop("style").width?a=parseFloat(b(this).prop("style").width):(a=b.trim(h.filterClass(b(this).attr("class")).replace("first","").replace("last","")),a=p[a]),n+=a)});t.css("width",100-n+"%")},drag:function(a,b){if(t&&0<t.length){var c=q+("e"===n?-b.position.left:
b.position.left),e=parseFloat(100*c/y);if(5<=e&&100>e){var d=A+C+("w"===n?-b.position.left:b.position.left),g=parseFloat(100*d/y);5<g&&100>g&&(t.css("width",d+"px"),f.css("width",c+"px").children("."+B).html(e.toFixed(2)+"%"),f.children(".themify_grid_drag_placeholder").last().html(g.toFixed(2)+"%"))}}}})})},initNewEditor:function(a){if("undefined"!==typeof tinyMCEPreInit.mceInit[a])return this.initMCEv4(a,tinyMCEPreInit.mceInit[a]);var b=this.tfb_hidden_editor_object;b.elements=a;b.selector="#"+
a;b.wp_autoresize_on=!1;tinyMCEPreInit.mceInit[a]=b;return this.initMCEv4(a,tinyMCEPreInit.mceInit[a])},initMCEv4:function(a,b){if(3<parseInt(tinyMCE.majorVersion)){var c=new tinyMCE.Editor(a,b,tinyMCE.EditorManager);c.render();return c}},initQuickTags:function(a){"function"===typeof QTags&&(quicktags({id:a}),QTags._buttonsInit())},setColorPicker:function(a){b(".builderColorSelectInput",a).each(function(){if(b(this).data("control-type"))return!0;d.Views.init_control("color",{el:b(this)})})},_getColClass:function(a){for(var c=
this.clearClass.split(" "),e=null,d=0;d<a.length;d++)-1<b.inArray(a[d],c)&&(e=a[d].replace("col",""));return e},saveBuilder:function(a,c,e){e=e||"main";var f=_.map(d.Instances.Builder,function(a,b){var c=a.$el.data("postid")||null,e=a.toJSON()||null;return{id:c,data:e}});console.log(f,"ids");return b.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tfb_save_data",tfb_load_nonce:themifyBuilder.tfb_load_nonce,ids:JSON.stringify(f),tfb_saveto:e},cache:!1,beforeSend:function(b){a&&ThemifyBuilderCommon.showLoader("show")},
success:function(e){a&&ThemifyBuilderCommon.showLoader("hide");b.isFunction(c)&&c.call(this,e);d.editing=!1;b("body").trigger("themify_builder_save_data")},error:function(){a&&ThemifyBuilderCommon.showLoader("error")}})},loadContentJs:function(a){"undefined"!==typeof ThemifyBuilderModuleJs&&ThemifyBuilderModuleJs.loadOnAjax(a);b("body").trigger("builder_load_on_ajax")},setupTooltips:function(){(function(){b("body").on("mouseover mouseout",'[rel^="themify-tooltip-"]',function(a){"mouseover"===a.type?
(a=b(this).data("title")?b(this).data("title"):b(this).prop("title"),b(this).append('<span class="themify_tooltip">'+a+"</span>")):b(this).children(".themify_tooltip").remove()})})();ThemifyBuilderCommon.setUpTooltip()},mediaUploader:function(){var a=b("body");a.on("click",".themify-builder-media-uploader",function(a){var c=b(this),d=c.closest(".themify_builder_input"),h=1===d.children("#background_image").length,d=1===d.children("#background_video").length,g=wp.media.frames.file_frame=wp.media({title:c.data("uploader-title"),
library:{type:c.data("library-type")?c.data("library-type"):"image"},button:{text:c.data("uploader-button-text")},multiple:!1});g.on("select",function(){var a=g.state().get("selection").first().toJSON();c.closest(".themify_builder_input").find(".themify-builder-uploader-input").val(a.url).trigger("change").parent().find(".img-placeholder").empty().html(b("<img/>",{src:a.url,width:50,height:50})).parent().show();c.closest(".themify_builder_input").find(".themify-builder-uploader-input-attach-id").val(a.id)});
if(h||d)0===b("#hide_attachment_display_settings").length&&b("body").append('<style id="hide_attachment_display_settings">.media-modal .attachment-display-settings { display:none }</style>'),g.on("close",function(a){b("#hide_attachment_display_settings").remove()});g.open();a.preventDefault()});a.on("click",".themify-builder-delete-thumb",function(a){b(this).prev().empty().parent().hide();b(this).closest(".themify_builder_input").find(".themify-builder-uploader-input").val("").trigger("change");a.preventDefault()});
...
e.preventDefault()})},setShortcodePreview:function(a,b){var c=b.next(".themify_builder_shortcode_preview"),d="";0===c.length&&(b.after('<div class="themify_builder_shortcode_preview"></div>'),c=b.next(".themify_builder_shortcode_preview"));for(var h in a)var g=a[h].attributes,d=d+('<img src="'+(g.sizes.thumbnail?g.sizes.thumbnail.url:g.url)+'" width="50" height="50" />');c.html(d)},createGradientPicker:function(a,c){if("undefined"!==typeof b.fn.ThemifyGradient){var e=a.closest(".themify-gradient-field"),
f=null,h=!1,g={onChange:function(b,c,e){a.val(b);h&&"visual"===d.mode&&(b="cover_gradient-gradient"===a.prop("name"),c=d.liveStylingInstance.bindBackgroundGradient(a.data("id"),c,b),b&&c&&d.liveStylingInstance.addOrRemoveComponentOverlay(c,!0))}};g.gradient=c?c:a.attr("data-default-gradient")?a.attr("data-default-gradient"):[];a.prev().ThemifyGradient(g);f=a.prev().data("ThemifyGradient");e.find(".themify-clear-gradient").on("click",function(b){b.preventDefault();f.settings.gradient="0% rgba(255,255,255, 1)|100% rgba(255,255,255,1)";
...
b){return 0===a.indexOf("data_control_repeater_")}).join(),h=b("#"+f.replace("data_control_repeater_","")),f=function(b){a.preview_element(c,this.getContent(),h)};_.isUndefined(this.binding_type)||(e.on("keyup change",f),b("#"+c).on("keyup change",function(){a.preview_element(c,this.value,h)}))}return this},reBind:function(){this.mceEditor=tinyMCE.get(this.$el.attr("id"));this.render()},resetEditor:function(){this.mceEditor=null}});d.Views.register_control("text",{initialize:function(){this.render()},
...
_.isUndefined(this.binding_type)||"refresh"!==this.binding_type||(d=_.throttle(function(){a.preview_element(c,this.value,f)},1E3));this.$el.on("change",d);return this}});d.Views.register_control("query_category",{initialize:function(){this.render()},render:function(){var a=this,b=a.$el.attr("id"),d=a.$el.parent(),f=d.find(".query_category_single"),h=d.find(".query_category_multiple"),g;f.add(h).on("change",function(c){g=h.val()?h.val()+"|multiple":f.val()+"|single";a.preview_element(b,g)});return this}});
...
a.$('input[type="checkbox"]:checked').map(function(){return this.value}).get();a.preview_element(b,c.join("|"))}});return this}});d.Views.register_control("color",{is_typing:!1,initialize:function(){this.render()},render:function(){var a=this,c=this.$el.parent().find(".builderColorSelect"),d=this.$el,f=c.parent().parent().find(".colordisplay"),h="",g=1,k=c.parent().parent().find(".color_opacity");d.val()&&(g=d.val(),-1!==g.indexOf("_")?(g=g.split("_"),h=g[0],g=g[1]?g[1]:1):(h=g,g=1),f.val(h),k.val(g));
c.minicolors({opacity:1,textfield:!1,change:_.debounce(function(e,g){var h=b(this).parent().parent().find(".builderColorSelectInput");if(e){g&&"0.99"==g&&(g="1");var l=e.replace("#","")+"_"+g;h.val(l);_.isUndefined(a.binding_type)||a.preview_element(h.prop("id"),l,b("#"+d.attr("data-control-repeater")));a.is_typing||(f.val(e.replace("#","")),k.is(":focus")||k.val(g));a.applyAll_verifyBorderColor(h,l,e.replace("#",""),e.replace("#",""),"change");b("body").trigger("themify_builder_color_picker_change",
[h.attr("name"),c.minicolors("rgbaString")])}else _.isUndefined(a.binding_type)||a.preview_element(h.prop("id"),"",b("#"+d.attr("data-control-repeater")))},200)});c.minicolors("value",h);c.minicolors("opacity",g);f.on("blur keyup",function(c){var d=b(this),e="",f=d.parent().find(".builderColorSelect"),g=d.parent().find(".builderColorSelectInput");d.val()&&(e=d.val());a.is_typing="keyup"===c.type;d.val(e.replace("#",""));g.val(d.val().replace(/[abcdef0123456789]{3,6}/i,e.replace("#","")));"keyup"===
c.type?f.minicolors("value",e):f.minicolors("value","").minicolors("value",e);a.applyAll_verifyBorderColor(g,g.val(),d.val(),e,c.type)});k.on("blur keyup",function(c){var d=b(this),e="",f=d.parent().find(".builderColorSelect");d.val()&&(e=d.val());a.is_typing="keyup"===c.type;d.val(e);f.minicolors("opacity",e)})},applyAll_verifyBorderColor:function(a,c,e,f,h){var g=!1;a=b(a);if(-1!==a.prop("name").indexOf("border_top_color")){var k=a.closest(".themify_builder_field").nextAll(".themify_builder_field");
k.each(function(){g=b(this).find(".style_apply_all_border");if(0<g.length)return!1});if(g&&g.is(":checked")){var l=null;"keyup"!==h?b(".builderColorSelectInput",k).each(function(){var a=b(this).closest(".themify_builder_input");l=a.find(".builderColorSelect");b(this).val(c);a.children(".colordisplay").val(e);l.minicolors("value",f)}):l=a.closest(".themify_builder_input").find(".builderColorSelect");"visual"===d.mode&&d.liveStylingInstance.setApplyBorder(a.prop("name"),l.minicolors("rgbaString"),"color")}}}});
